...
tenancy_id = "ocid1.tenancy.oc1..aaaaaaaahrs4avamaxiscouyeoirc7hz5byvumwyvjedslpsdb2d2xe2kp2q"

# Get this from OCI > Identity > Users (for your user account)
user_id = "ocid1.user.oc1..aaaaaaaae4iep5wzdfqboxws6mlubt4rssygmmu7oek6qq2di7lgyzlqk5sq"

# the fingerprint can be gathered from your user account (OCI > Identity > Users > click your username > API Keys fingerprint (select it, copy it and paste it below))
fingerprint = "4f:90:09:d7:2a:ea:81:a8:76:97:2a:51:9c:e9:36:03"

# this is the full path on your local system to the private key used for the API key pair
private_key_path = "C:/Travail/Travail2019/Demos/InfraAsCode/DevOpsDb/SshKeys/APIKeys/bmcs_api_key.pem"
